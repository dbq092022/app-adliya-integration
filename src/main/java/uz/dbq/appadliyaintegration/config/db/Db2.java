...
@Configuration
@ConfigurationProperties("spring.datasource.data-base-second")
...
public class Db2 {
    ...
    private static final String POOL_NAME = "dataBaseSecond";

    private static HikariDataSource hikariDataSource;

    @Value("${spring.datasource.data-base-second.url}")
    private String jdbcUrl;

    @Value("${spring.datasource.data-base-second.driver-class-name}")
    private String driverClassName;

    @Value("${spring.datasource.data-base-second.username}")
    private String username;

    @Value("${spring.datasource.data-base-second.password}")
    private String password;

    protected final String PERSISTENCE_UNIT_NAME = "dataBaseSecond";
    ...
    @Bean
    @Qualifier("dataBaseSecond")
    public HikariDataSource dataBaseSecond() throws UnknownHostException, SocketException {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryDataBaseSecond(
        ...
        return new LocalContainerEntityManagerFactoryBean() {{
            setDataSource(dataBaseSecond);
            setPersistenceProviderClass(HibernatePersistenceProvider.class);
            setPersistenceUnitName(PERSISTENCE_UNIT_NAME);
            setPackagesToScan("uz.dbq.appadliyaintegration.entity.entity2");
